    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex align-items-center mb-5">
                <img src="{{ site.baseurl }}/assets/icons/about-avatar.svg" class="rounded-circle shadow-sm me-4" alt="Tamilarasu Arunachalam" width="150" height="150"/>
                <div>
            ...
            <div class="fs-5 content-area">
                ...
                <p>On this blog, I share my own development learnings, honest insights, and the technical breakdown of the tools I build. My goal is simple: to help you make informed decisions about the technology you invite into your workspace.</p>
